...
// RecommendationParser is parser for MyAnimeList anime recommendation information.
...
// getID to get recommended anime id.
...
// getTitle to get recommended anime title.
